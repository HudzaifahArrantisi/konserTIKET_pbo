...
<body class="bg-gray-900 text-white min-h-screen flex items-center justify-center">
    <div class="w-full max-w-md">
        <div class="text-center mb-8">
            <h1 class="text-4xl font-bold gradient-text mb-2">THE HYPE MACHINE</h1>
        ...
        <div class="bg-gray-800 rounded-2xl p-8 shadow-2xl">
            ...
            <c:if test="${not empty success}">
                <div class="mb-4 p-3 bg-green-500/20 border border-green-500 rounded-lg">
                    <p class="text-green-300">${success}</p>
                </div>
            </c:if>
            
            <form action="/concert/auth/login" method="post">
                <div class="mb-6">
            ...
            <div class="mt-6 text-center">
                <p class="text-gray-400">
                    ...
                    <a href="/concert/auth/register" class="text-purple-400 hover:text-purple-300 font-medium">
                        Register here
                    </a>
                </p>
